...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('public/assets/admin/vendors/css/charts/chartist-plugin-tooltip.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('public/assets/admin/vendors/css/forms/toggle/bootstrap-switch.min.css')}}">
    ...
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('public/assets/admin/css-rtl/style-rtl.css')}}">
    <!-- END Custom CSS-->
    @notify_css
    @yield('style')
