                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                                <a href="{{route('admin.languages.edite',$language -> id)}}" >
                                                                 ...
                                                                 {{-- <button type="button" onclick="ajax_query('{{route('add.cart',$items-> id)}}')"  class="btn btn-primary me-3 add float-start">add to cart</button> --}}

                                                                <a class="  box-shadow-3 mr-1 mb-1">
                                                                    <button class="btn btn-outline-danger" type="button" onclick="ajax_query('{{route('admin.languages.delete',$language-> id)}}')"  class="btn btn-primary me-3 add float-start">
