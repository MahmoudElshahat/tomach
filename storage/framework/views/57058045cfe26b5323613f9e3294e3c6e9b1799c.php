...
-->
    ...
    <?php $__currentLoopData = $users['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
     ...
     <section class="d-flex justify-content-center">
        ...
        <div class="row d-flex">
            <div class="col-6 d-flex justify-content-end" style="padding: 0;">
                <a href="#" onclick="ajax_query('<?php echo e(route('add.cart',$item-> id)); ?>')" class="d-flex justify-content-center"><img style="    width: 100%;" src="<?php echo e(config('constans.images_path').$item->photo); ?>" alt="">

                </a>
            </div>
            <div class="col-6" style="padding: 0;"><a href="<?php echo e(route('add.cart',$item-> id)); ?>"><img style="    width: 100%;"  src="<?php echo e(config('constans.images_path').$item->photo); ?>" alt=""></a></div>
        </div>
    ...
    <v-row class="d-flex justify-content-center">
      <v-col>
        <a href="<?php echo e(route('add.cart',$item-> id)); ?>" ><img style="width:100%;"  src="<?php echo e(config('constans.images_path').$item->photo); ?>" alt=""></a>
      </v-col>
      <v-col>
        <a href="<?php echo e(route('add.cart',$item-> id)); ?>" ><img style="width:100%;"  src="<?php echo e(config('constans.images_path').$item->photo); ?>" alt=""></a>
      </v-col>
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/resturant/resources/views/front/home.blade.php ENDPATH**/ ?>