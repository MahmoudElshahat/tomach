            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">Welcome
                        ...
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href=""><i
                                    class="ft-user"></i> <?php echo e(session('user_name')); ?></a>
                            <div class="dropdown-divider"></div>

                            <a href="<?php echo e(route('logout')); ?>" class="dropdown-item"> <i class="ft-power"></i> Log out  </a>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <a class="nav-link nav-link-label" href="<?php echo e(route('back.home')); ?>" >Home</li></a>
...
<?php /**PATH /opt/lampp/htdocs/resturant/resources/views/admin/includes/header.blade.php ENDPATH**/ ?>