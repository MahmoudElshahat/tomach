                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo e(route('admin.languages')); ?>"> أللغات </a>
                                </li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" id="lang_edite" action="" method="POST"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-actions">
                                                        ...
                                                        <div id="succes-msg" class="alert alert-success" style="display:none; text-align:center" >
                                                            <h2>Success Edite</h2><i class="bi bi-check"></i>
                                                        </div>

                                                    
                                                        <div id="fail-msg" class="alert alert-danger" style="display:none; text-align:center" >
                                                            <h2>failed!!:'Please rturn after moment'</h2>
                                                        </div>
                                                ...
                                                <button type="submit" onclick="upload_data('#lang_edite','<?php echo e(route('admin.languages.update',$languages -> id)); ?>')" class="btn btn-primary">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/resturant/resources/views/admin/languages/edit.blade.php ENDPATH**/ ?>