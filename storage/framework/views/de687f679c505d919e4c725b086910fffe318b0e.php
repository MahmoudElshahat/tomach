...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/admin/vendors/css/forms/icheck/icheck.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/admin/vendors/css/forms/icheck/custom.css')); ?>">
    <!-- END VENDOR CSS-->
    <!-- BEGIN MODERN CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/assets/admin/css-rtl/pages/login-register.css')); ?>">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
...
<script src="<?php echo e(asset('public/assets/admin/vendors/js/forms/validation/jqBootstrapValidation.js')); ?>"
...
<!-- END MODERN JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="<?php echo e(asset('public/assets/admin/js/scripts/forms/form-login-register.js')); ?>" type="text/javascript"></script>
<!-- END PAGE LEVEL JS-->
...
<?php /**PATH /opt/lampp/htdocs/resturant/resources/views/layouts/login.blade.php ENDPATH**/ ?>