            ...
            <div class="col-md-4 col-10 box-shadow-2 p-0">
                <div class="card border-grey border-lighten-3 m-0">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal form-simple" action="<?php echo e(route('insert.admin')); ?>" method="post"
                                  novalidate>
                                <?php echo csrf_field(); ?>
                                ...
                                <fieldset class="form-group position-relative has-icon-left mb-0">
                                    <input type="text" name="name" class="form-control form-control-lg input-lg"
                                           value="<?php echo e(old('name')); ?>" id="email" placeholder=" Name">
                                ...
                                <fieldset class="form-group position-relative has-icon-left mb-0">
                                    <input type="text" name="phone" class="form-control form-control-lg input-lg"
                                           value="<?php echo e(old('phone')); ?>" id="phone" placeholder="phone numder">
...
<?php echo $__env->make('layouts.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/resturant/resources/views/admin/Auth/signup.blade.php ENDPATH**/ ?>