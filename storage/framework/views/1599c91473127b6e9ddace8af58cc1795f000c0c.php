                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form" action="<?php echo e(route('update.item',$items-> id)); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="<?php echo e(public_path('images'.$items-> image_path)); ?>" alt="<?php echo e(public_path('images'.$items-> image_path)); ?>">

                                            <input type='hidden'  name='id' value="<?php echo e($items-> name); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/resturant/resources/views/admin/items/edite.blade.php ENDPATH**/ ?>